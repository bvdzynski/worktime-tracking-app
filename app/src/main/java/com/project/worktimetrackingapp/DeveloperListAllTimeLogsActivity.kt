...
class DeveloperListAllTimeLogsActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private val timeLogRecyclerAdapter by lazy {
        TimeLogRecyclerAdapter(this, DataManager.getTimeLogs(roleInTeam).reversed())
    }
    ...
    private fun displayTimeLogs() {
        ...
        (listItems.adapter as TimeLogRecyclerAdapter).notifyDataSetChanged()
    ...
    private fun displayProjects() {
        ...
        (listItems.adapter as ProjectRecyclerAdapter).notifyDataSetChanged()
