...
import kotlinx.android.synthetic.main.app_bar_time_logs.*
import kotlinx.android.synthetic.main.content_time_logs.*

class DeveloperViewActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private val projectRecyclerAdapter by lazy {
        ProjectRecyclerAdapter(this, DataManager.projects.values.toList())
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener { view ->
            startActivity(Intent(this, EditTimeLogActivity::class.java))
        }
